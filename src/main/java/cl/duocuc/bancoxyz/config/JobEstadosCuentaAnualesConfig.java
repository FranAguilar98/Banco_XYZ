...
public class JobEstadosCuentaAnualesConfig {
    ...
    @Bean
    public SynchronizedItemStreamReader<CuentaAnualCsv> cuentaAnualItemReaderSincronizado() {
        SynchronizedItemStreamReader<CuentaAnualCsv> reader = new SynchronizedItemStreamReader<>();
    ...
    public Tasklet estadoCuentaAnualTasklet() {
        return (contribution, chunkContext) -> {
            ...
            // Agrupar por cuenta_id + anio de la fecha del movimiento
    ...
    public Job generacionEstadosCuentaAnualesJob() {
        return new JobBuilder("generacionEstadosCuentaAnualesJob", jobRepository)
                ...
                .start(stepCargaMovimientosAnuales())
